...
public:
    ...
    /// @{
    virtual void drawPoints(const sofa::helper::vector<Vector3> &points, float size,  const Vec4f colour) = 0 ;
    virtual void drawPoints(const sofa::helper::vector<Vector3> &points, float size, const sofa::helper::vector<Vec4f> colour) = 0;
    virtual void drawLines(const sofa::helper::vector<Vector3> &points, float size, const Vec4f colour) = 0 ;
    virtual void drawLines(const sofa::helper::vector<Vector3> &points, const sofa::helper::vector< Vec2i > &index , float size, const Vec4f colour) = 0 ;

    virtual void drawTriangles(const sofa::helper::vector<Vector3> &points, const Vec4f colour) = 0 ;
    virtual void drawTriangles(const sofa::helper::vector<Vector3> &points, const Vector3 normal, const Vec4f colour) = 0 ;
    ...
    virtual void drawTriangles(const sofa::helper::vector<Vector3> &points,
            const sofa::helper::vector<Vector3>  &normal,
            const sofa::helper::vector< Vec4f > &colour) = 0 ;
    ...
    virtual void drawSpheres (const sofa::helper::vector<Vector3> &points, const sofa::helper::vector<float>& radius, const Vec4f colour) = 0;
    virtual void drawSpheres (const sofa::helper::vector<Vector3> &points, float radius, const Vec4f colour) = 0 ;
