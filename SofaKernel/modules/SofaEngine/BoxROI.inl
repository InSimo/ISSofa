...
void BoxROI<DataTypes>::update()
{
    ...
    WriteOnlyAccessor< Data<helper::vector<Edge> > > edgesOutROI = f_edgesOutROI;
    WriteOnlyAccessor< Data<helper::vector<Triangle> > > trianglesOutROI = f_trianglesOutROI;
    WriteOnlyAccessor< Data<helper::vector<Tetra> > > tetrahedraOutROI = f_tetrahedraOutROI;
    WriteOnlyAccessor< Data<helper::vector<Hexa> > > hexahedraOutROI = f_hexahedraOutROI;
    WriteOnlyAccessor< Data<helper::vector<Quad> > > quadOutROI = f_quadOutROI;
