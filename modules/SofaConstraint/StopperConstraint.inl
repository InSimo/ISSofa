...
{
    this->mstate = MechanicalState::DynamicCast(this->getContext()->getMechanicalState());
    assert(this->mstate);
...
template<class DataTypes>
void StopperConstraint<DataTypes>::getConstraintResolution(const core::ConstraintParams* /*cParams*/, std::vector<core::behavior::ConstraintResolution*>& resTab, unsigned int& offset)
{
    for(int i=0; i<1; i++)
