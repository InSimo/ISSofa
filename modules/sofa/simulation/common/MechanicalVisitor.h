...
public:
    ...
    MechanicalPropagateDxVisitor( const sofa::core::MechanicalParams* mparams /* PARAMS FIRST  = sofa::core::MechanicalParams::defaultInstance()*/, 
                                  sofa::core::MultiVecDerivId dx, bool /*ignoreMask_deprecated*/, bool f = false )
...
class SOFA_SIMULATION_COMMON_API MechanicalProjectPositionAndVelocityVisitor : public MechanicalVisitor
{
public:
    double t;
    sofa::core::MultiVecCoordId pos;
...
public:
    ...
    /// Return a class name for this visitor
    /// Only used for debugging / profiling purposes
    virtual const char* getClassName() const { static std::string name= "MechanicalComputeContactForceVisitor["+res.getName()+"]"; return name.c_str(); }
