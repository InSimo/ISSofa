...
public:
    ...
    ParallelMechanicalVDotVisitor( const sofa::core::ExecParams* params /* PARAMS FIRST  = sofa::core::ExecParams::defaultInstance()*/, Shared<double>* t, ConstMultiVecId a, ConstMultiVecId b) 
    : BaseMechanicalVisitor(params)
    , a(a)
    , b(b)
    , totalSh(t)
