...
public:
    ...
    typedef typename sofa::component::topology::Triangle Triangle;
    typedef typename sofa::component::topology::Edge Edge;
    typedef typename sofa::component::topology::Point Point;
...
public:
    ...
    typedef typename sofa::component::topology::TriangleSetTopologyContainer TriangleSetTopologyContainer;
    typedef typename sofa::component::topology::PointID PointID;
    typedef typename sofa::component::topology::TriangleID TriangleID;
    typedef typename sofa::component::topology::Triangle Triangle;
    typedef typename sofa::component::topology::TrianglesAroundVertex TrianglesAroundVertex;
