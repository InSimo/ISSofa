...
public:
    ...
    virtual const sofa::helper::vector<unsigned int> getConnectedElement(unsigned int elem) override;

    /// Returns the set of element indices adjacent to a given element (i.e. sharing a link)
    virtual const sofa::helper::vector<unsigned int> getElementAroundElement(unsigned int elem) override;
    /// Returns the set of element indices adjacent to a given list of elements (i.e. sharing a link)
    virtual const sofa::helper::vector<unsigned int> getElementAroundElements(sofa::helper::vector<unsigned int> elems) override;
    /// @}
    ...
    virtual double getPX(int i) const override;
    virtual double getPY(int i) const override;
    virtual double getPZ(int i) const override;
