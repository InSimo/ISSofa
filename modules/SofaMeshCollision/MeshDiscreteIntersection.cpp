...
******************************************************************************/
#include <SofaMeshCollision/MeshDiscreteIntersection.inl>
...
int MeshDiscreteIntersection::computeIntersection(Triangle& e1, Line& e2, OutputContainer<Triangle, Line>* contacts)
{
    Vector3 A = e1.p1();
    Vector3 AB = e1.p2()-A;
    Vector3 AC = e1.p3()-A;
