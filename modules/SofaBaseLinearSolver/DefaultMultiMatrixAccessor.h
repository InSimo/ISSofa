 ...
 * with CompressedRowSparseMatrixMechanicalMechanical.
 *
 * To be able to creat  CompressedRowSparseMatrixMechanicalMechanical, it is needle to know about block format of relied to the
...
{
    typedef CompressedRowSparseMatrixMechanicalMechanical< defaulttype::Mat<blocRsize, blocCsize, elementType> > BlocMatrix;
...
inline bool opAddMulJTM_TBloc(defaulttype::BaseMatrix* out, defaulttype::BaseMatrix* J, defaulttype::BaseMatrix* stiffMatrix2, int offsetRow, int offsetCol, bool _debug)
{
    ...
    typedef CompressedRowSparseMatrixMechanical<JBloc>                       JMatrix;
    ...
    typedef CompressedRowSparseMatrixMechanical<MBloc>                       MMatrix;
    ...
    typedef CompressedRowSparseMatrixMechanical<OutBloc>                     OutMatrix;
