...
void PartialLinearMovementConstraint<DataTypes>::interpolatePosition(Real cT, typename disable_if_is_rigid<MyCoord>::type& x)
{
    const SetIndexArray & indices = m_indices.getValue();
...
template <class DataTypes>
template <class MyCoord>
void PartialLinearMovementConstraint<DataTypes>::interpolatePosition(Real cT, typename enable_if_is_rigid<MyCoord>::type& x)
{
    const SetIndexArray & indices = m_indices.getValue();
