...
void TriangleMesh2PointTopologicalMapping_test::addOneTriangleFrom()
{
    ...
    trianglesToAdd.push_back(Triangle(m_triangleContainerFrom->getNbPoints(),
...
{
    TriangleSetTopologyContainer::SeqTriangles trianglesToAdd;
    trianglesToAdd.push_back(Triangle(0, 3, 1));
    trianglesToAdd.push_back(Triangle(1, 3, 2));
    trianglesToAdd.push_back(Triangle(2, 3, 0));
